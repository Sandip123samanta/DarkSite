  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute h-5 w-5 border border-white inline-flex justify-center items-center top-1/2 left-full rounded-full -translate-x-1/2 -translate-y-1/2">
      ...
      <div className="container relative mt-16">
        <h1 className="text-8xl md:text-[168px] font-semibold tracking-tighter bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text text-center">
          AI SEO
        </h1>
